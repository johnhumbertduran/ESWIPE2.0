...
namespace ESWIPE.Views
{
    ...
    public partial class Q1StudentPage : ContentPage
    {
        public string Key;
        ...
        protected override async void OnAppearing()
        {
            ...
            {
                Teacher = Preferences.Get("Teacher", "TeacherValue");
            }
            ...
            if (CheckContents != null)
            {
                if (CheckContents.TitleContent != null)
                {
                    ...
                    Q1Label.IsVisible = false;
                }
            }
            else
            {
                myListView.IsVisible = false;
                Q1Label.IsVisible = true;
            }
        }
